...
class PaymentEdgeCaseTest(TestCase):
    ...
    def test_payment_duplicate_prevention(self):
        ...
        payment2 = Payment.objects.create(
            ...
            amount=Decimal('100.00'),
            currency='USD',
            transaction_id='unique_123'  # Same transaction ID
        )
        
        # At model level this works, business logic would prevent this
        duplicate_payments = Payment.objects.filter(transaction_id='unique_123')
    ...
    def test_payment_refund_workflow(self):
        ...
        refund_payment = Payment.objects.create(
            ...
            currency='USD',
            transaction_id=f'refund_{original_payment.payment_id}'
        )
        
        self.assertEqual(refund_payment.amount, Decimal('30.00'))
        self.assertIn('refund_', refund_payment.transaction_id)
